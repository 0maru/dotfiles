      ...
      sections: [
        ...
        },
        {
          ...
          items: [
            ...
            { mode: "N", keys: ["Ctrl+w", "+"], desc: "ペインの高さを広げる", lv: 3 },
            { mode: "N", keys: ["Ctrl+w", "-"], desc: "ペインの高さを狭める", lv: 3 },
            { mode: "N", keys: ["Ctrl+w", ">"], desc: "ペインの幅を広げる", lv: 3 },
            { mode: "N", keys: ["Ctrl+w", "<"], desc: "ペインの幅を狭める", lv: 3 },
