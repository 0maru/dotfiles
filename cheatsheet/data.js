      ...
      sections: [
        {
          ...
          items: [
            ...
            { mode: "NV", keys: ["Space", "y"], desc: "motion / 選択範囲をシステムクリップボードへヤンク", lv: 2 },
            { mode: "N", keys: ["Space", "Y"], desc: "行をシステムクリップボードへヤンク", lv: 2 },
            { mode: "NV", keys: ["Space", "d"], desc: "motion / 選択範囲をヤンクせず削除", lv: 2 },
            { mode: "I", keys: ["j", "k"], desc: "Insert を抜ける", lv: 1 },
            { mode: "NV", keys: [";"], desc: "コマンドラインを開く", lv: 1 },
            { mode: "NV", keys: [":"], desc: "直前の f/t 検索を繰り返す", lv: 3 },
        ...
        },
        {
          title: "素の Vim 基本動作",
          items: [
            { keys: ["j"], desc: "下へ移動 (折り返し行は表示行)", lv: 1 },
            { keys: ["k"], desc: "上へ移動 (折り返し行は表示行)", lv: 1 },
      ...
      sections: [
        ...
        },
        {
          ...
          items: [
            ...
            { mode: "I", keys: ["LSP"], desc: "Neovim 0.12 の built-in completion を自動起動", lv: 2, static: true },
            { mode: "I", keys: ["入力"], desc: "blink.cmp の補完 / signature", lv: 2, static: true },
            { mode: "I", keys: ["popup"], desc: "補完ポップアップは fuzzy + rounded border", lv: 3, static: true },
        ...
        },
        {
          ...
          items: [
            ...
            { mode: "O", keys: ["r"], desc: "Flash remote (operator)", lv: 4 },
        ...
        },
        {
          ...
          items: [
            ...
            { keys: ["]C"], desc: "次のクラス末尾", lv: 3 },
            { keys: ["[C"], desc: "前のクラス末尾", lv: 3 },
            { keys: ["]a"], desc: "次の引数", lv: 3 },
            { keys: ["[a"], desc: "前の引数", lv: 3 },
            { keys: ["]A"], desc: "次の引数末尾", lv: 3 },
            { keys: ["[A"], desc: "前の引数末尾", lv: 3 },
      ...
      sections: [
        ...
        },
        {
          ...
          items: [
            ...
            { mode: "N", keys: ["Space", "hn"], desc: "次のハンク", lv: 2 },
            { mode: "N", keys: ["Space", "hp"], desc: "前のハンク", lv: 2 },
            ...
            { mode: "N", keys: ["Space", "tb"], desc: "行末 blame トグル (初期ON)", lv: 2 },
      ...
      sections: [
        {
          title: "自動動作",
          notes: [
            "Neovim v0.12.2 / lazy.nvim / lazy-lock.json は 40 plugins",
        ...
        },
        {
          ...
          notes: [
            ...
            "completeopt = menu, menuone, noselect, fuzzy, popup / pumborder=rounded",
            "listchars 表示",
            "lualine.nvim (statusline) + bufferline.nvim",
            "hlchunk.nvim でインデント / チャンク補助",
            "nvim-scrollbar + dropbar.nvim",
            "LSP: lua_ls / pyright / typos_lsp / volar / gopls / rust_analyzer / dartls / tailwindcss / biome / eslint / html / css_variables / cssls / cssmodules_ls / taplo",
          ],
        },
        {
          title: "プラグイン (40)",
          groups: [
            {
              label: "基盤 / 依存",
              plugins: ["lazy.nvim", "plenary.nvim", "nui.nvim", "nvim-web-devicons", "friendly-snippets"],
            },
            {
              label: "検索 / 起動",
              plugins: ["snacks.nvim", "which-key.nvim", "dashboard-nvim", "grug-far.nvim"],
            },
            {
              label: "ファイラー / 分割",
